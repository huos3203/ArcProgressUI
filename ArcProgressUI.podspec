...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ArcProgressUI.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/huo3203@hotmail.com/ArcProgressUI'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'huo3203@hotmail.com' => '724987481' }
  s.source           = { :git => 'https://github.com/huo3203@hotmail.com/ArcProgressUI.git', :tag => s.version.to_s }
